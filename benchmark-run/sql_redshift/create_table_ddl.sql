CREATE TABLE customer_:database_id:(
C_CustKey int ,
C_Name varchar(64) ,
...
CREATE TABLE lineitem_:database_id:(
L_OrderKey int ,
L_PartKey int ,
L_SuppKey int ,
L_LineNumber int ,
...
CREATE TABLE nation_:database_id:(
N_NationKey int ,
N_Name varchar(64) ,
N_RegionKey int ,
...
CREATE TABLE orders_:database_id:(
O_OrderKey int ,
O_CustKey int ,
...
CREATE TABLE part_:database_id:(
P_PartKey int ,
P_Name varchar(64) ,
P_Mfgr varchar(64) ,
P_Brand varchar(64) ,
...
CREATE TABLE partsupp_:database_id:(
PS_PartKey int ,
PS_SuppKey int ,
PS_AvailQty int ,
...
CREATE TABLE region_:database_id:(
R_RegionKey int ,
R_Name varchar(64) ,
R_Comment varchar(160)
);

CREATE TABLE supplier_:database_id:(
S_SuppKey int ,
S_Name varchar(64) ,
